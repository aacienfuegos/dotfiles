...
_G.packer_plugins = {
  ...
  ["vim-commentary"] = {
    loaded = true,
    path = "/home/aacienfuegos/.local/share/nvim/site/pack/packer/start/vim-commentary",
  ...
  ["vim-gitgutter"] = {
    loaded = true,
    path = "/home/aacienfuegos/.local/share/nvim/site/pack/packer/start/vim-gitgutter",
