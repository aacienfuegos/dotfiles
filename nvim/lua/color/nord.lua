...
-- VimWiki
Group.new("NvimTreeNormal", groups.PmenuSbar, groups.PmenuSbar)
Group.new("VimwikiBold",    colors.green, colors.none)
Group.new("VimwikiItalic",  colors.none, colors.none)
Group.new("VimwikiItalicBold",colors.none, colors.none)
Group.new("VimwikiUnderline",colors.none, colors.none)
...
Group.new("VimwikiLink",colors.none, colors.none)
...
Group.new("VimwikiHeader4", colors.magenta, colors.none)
Group.new("VimwikiHeader5", colors.cyan, colors.none)
